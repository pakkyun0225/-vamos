        ...
        {projects.map((proj, index) => (
          <div key={index} className="Projects_projects__PvBb6">
            <div className="Projects_project__hHhvb">
              <div className="Projects_title__0IuQ3">{proj.name}</div>
              ...
              <div class="Projects_info___utyZ">
                <div class="Projects_img-carousel__e8hwy">
                  <div className="Projects_imgs__datEq">
                    <div class="Projects_img-wrapper__0b8Tt"><img class="Projects_img__OAyqd" src={proj.imgsrc[0]} alt="" /></div>
                    <div class="Projects_img-wrapper__0b8Tt"><img class="Projects_img__OAyqd" src={proj.imgsrc[1]} alt="" /></div>
                    <div class="Projects_img-wrapper__0b8Tt"><img class="Projects_img__OAyqd" src={proj.imgsrc[2]} alt="" /></div>
                  </div>
                  <nav class="Projects_nav__Inoba">
                    <div class="Projects_prev__wS3_z"><img src="/images/arrow-left.svg" alt="" /></div>
                    <div class="Projects_page__zHIqO">1/3</div>
                ...
                <div class="Projects_descriptions__2g3bi">
                  ...
                  <div class="Projects_description___gCV_">
                    <div class="Projects_label__OLO6p">{proj.techstack[0]}</div>
                    <div class="Projects_value__B9RY_">{proj.tech[0]}</div>
                  </div>
                  <div class="Projects_description___gCV_">
                    <div class="Projects_label__OLO6p">{proj.techstack[1]}</div>
                    <div class="Projects_value__B9RY_">{proj.tech[1]}</div>
                  </div>
                  <div class="Projects_description___gCV_">
                    <div class="Projects_label__OLO6p">{proj.techstack[2]}</div>
                    <div class="Projects_value__B9RY_">{proj.tech[2]}</div>
                  </div>
                </div>
              </div>
            </div>
